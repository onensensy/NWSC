...
<form id="form1" name="form1" method="post" action="">
  <table width="500" align="center">
    <tr>
      <td colspan="2" bgcolor="#0000FF" ><h1 align="center">Branch's Details</h1></td>
    </tr>
   
    <tr>
      <td width="140"><div align="right"><strong>BranchNumber </strong></div></td>
      <td width="300"><label>
        <input type="text" name="branchNo" size="50"/>
      </label></td>
    </tr>
    <tr>
      <td><div align="right"><strong>BranchName </strong></div></td>
  ...
  <td width="300"><select name="location" >
    ...
    <tr>
	  ...
	  <tr><td bgcolor="#0000FF"><input type="reset" name="rest" value="reset" /> </td>
		  <td bgcolor="#0000FF"><input name="submit" type="submit" id="submit" value="Submit" /></td></tr>
  </table>
</form>
</body>
</html>
